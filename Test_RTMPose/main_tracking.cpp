...
int main(int argc, char* argv[]) {
    ...
    std::string pose_model = "D:/Dev/Project/Test_RTMPose/models/RTMPose/cocowholebody/384x288/rtmpose_cocowholebody_l_384x288";
    std::string input = "D:/Dev/Dataset/inputs/images/multi/multi_2.jpg";
    std::string output = "D:/Dev/Project/Test_RTMPose/demo/outputs/384x288_cocowholebodyl_rtmdet_m.jpg";
