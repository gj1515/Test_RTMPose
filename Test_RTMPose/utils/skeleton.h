...
const Skeleton& gSkeletonHalpe26() {
    static const Skeleton inst{
        {
            {15, 13}, {13, 11}, {11, 19}, {16, 14}, {14, 12}, {12, 19}, {17, 18}, {18, 19},
            {18, 5}, {5, 7}, {7, 9}, {18, 6}, {6, 8}, {8, 10}, {1, 2}, {0, 1},
            {0, 2}, {1, 3}, {2, 4}, {3, 5}, {4, 6}, {15, 20}, {15, 22}, {15, 24},
            {16, 21}, {16, 23}, {16, 25},
        },
        {
            {0, 255, 0}, // green
...
inline Skeleton Skeleton::get(const std::string& path) {
  ...
  else if (path == "halpe26") {
      return gSkeletonHalpe26();
  }
